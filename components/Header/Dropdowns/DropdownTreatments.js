...
export default function DropdownTreatments() {
  return (
    <div className="group inline-block opacity-70 hover:opacity-100">
      ...
      <ul
        className="font-poppins absolute origin-top scale-0 transform cursor-pointer rounded-b-md border 
        bg-white pb-2 tracking-wide transition duration-150 ease-in-out group-hover:scale-100"
      >
