  ...
  return (
    <div className="mt-4 lg:mt-10 border-t border-gray-200 pt-14 lg:pt-20 lg:pb-40">
      ...
      <h2 className="text-lg lg:text-xl opacity-70 poppins font-light mx-6 lg:mx-40">
        ...
        blodstrømmen. Våre spa mani-pedi-behandlinger vil gi deg et avslappende
        sinn og avlaste deg fra stress og spenninger samtidig som du får
        nydelige negler og vakkert preparerte hender og føtter! Vi steriliserer
        utstyret vårt i varmluftsterilisator ved 250 grader for å beskytte våre
        kunder mot potensielle risikoer som kan føre til infeksjon.
      </h2>
