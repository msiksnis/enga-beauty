...
export default function PriceList() {
  return (
    <div className="lg:mt-24 lg:pt-20 lg:mx-20 mt-10 border-t border-gray-100">
      <div className="lg:flex-row lg:justify-around lg:space-x-6 flex flex-col">
        <div className="w-full mt-10">
          <h2 className="lg:justify-center md:ml-10 lg:ml-0 montserrat flex mb-4 ml-6 text-2xl font-medium">
            Håndpleie
          </h2>
          <div className="mb-2">
            <Image
          ...
          <div className="bg-[#FCFAFA] py-4 lg:px-2">
            <h3 className="md:ml-10 lg:ml-0 montserrat flex mb-6 ml-6 text-xl font-medium">
              Håndpleie Dame
            </h3>

            <Table treatment="Mini manikyr" price="400" />
            <p className="montserrat md:mx-10 lg:mx-0 opacity-60 py-1 mx-6 text-sm border-b border-gray-200"></p>
            ...
            <h3 className="md:mx-10 lg:ml-0 montserrat flex mt-12 mb-6 ml-6 text-xl font-medium">
              Håndpleie Herre
            </h3>
        ...
        <div className="w-full mt-10">
          <h2 className="lg:justify-center md:mx-10 lg:ml-0 montserrat flex mb-4 ml-6 text-2xl font-medium">
            Fotpleie
          </h2>
          <div className="mb-2">
            <Image
          ...
          <div className="bg-[#FCFAFA] pt-1 lg:pt-4 pb-4 lg:px-2">
            <h3 className="md:mx-10 lg:ml-0 montserrat flex mb-6 ml-6 text-xl font-medium">
              Fotpleie Dame
            </h3>
        ...
        <div className="w-full mt-10">
          ...
          <div className="bg-[#FCFAFA] pt-1 lg:pt-4 pb-4 lg:px-2">
            ...
            <h3 className="md:mx-10 lg:ml-0 montserrat flex mt-10 mb-6 ml-6 text-xl font-medium">
