      ...
      <div className="flex flex-col lg:flex-row lg:justify-around lg:space-x-6">
        ...
        <div className="w-full md:w-96 mt-10">
          ...
          <Image
            ...
            height={330}
          />
          <Table treatment="Mini pedikyr" price="399" />
          <p className="montserrat text-sm border-b border-gray-200">
            Mykgjørende salt, fuktighetsgivende kremmassasje + shellac med base
            og topcoat
          </p>
          <Table treatment="SPA pedikyr" price="499" />
          <p className="montserrat text-sm border-b border-gray-200">
            Bløtgjørende salt, fuktighetsgivende kremmassasje, varmt håndkle,
            skrubbeeksfoliering, kremmaske, trim og neglebåndsbrudgom (+ shellac
            med base og topcoat 99kr)
          </p>
          <Table treatment="Deluxe pedikyr" price="599" />
          <p className="montserrat text-sm border-b border-gray-200">
          ...
          <p className="montserrat text-sm border-b border-gray-200">
            Kokosmelk fotbad, terapeutisk oljemassasje, varm stein, varmt
            håndkle, skrubbeeksfoliering, parafinmaske, trim og
            neglebåndsbrudgom + shellac med base og topcoat
          </p>
          <Table treatment="Platinum signature pedikyr" price="799" />
          <p className="montserrat text-sm border-b border-gray-200">
            Kokosmelk fotbad, terapeutisk oljemassasje, varm stein, varmt
            håndkle, skrubbeeksfoliering, parafinmaske, trim og
            neglebåndsbrudgom + shellac med base og topcoat
          </p>
          <Table treatment="Paraffin behandling" price="249" />
          <p className="montserrat text-sm border-b border-gray-200">
            Mykgjørende saltbøt, varm håndkle, skrubeeksfoliering, paraffin bad
          </p>
          <Table treatment="Nytt sett gelenegler" price="599" />
          <p className="montserrat text-sm border-b border-gray-200">
            Med mini pedikyr
          </p>
          <Table treatment="Fjerning av gelenegler" price="349" />
          <p className="montserrat text-sm border-b border-gray-200">
            Med mini pedikyr
          </p>
          <Table treatment="Fjerning av shellac" price="249" />
          <p className="montserrat text-sm border-b border-gray-200">
            Med mini pedikyr
          </p>
          <Table treatment="Reparasjon av en negl" price="49" />
          <p className="montserrat text-sm border-b border-gray-200"></p>

          <h2 className="flex lg:justify-center ml-6 lg:ml-0 montserrat text-xl mb-4 mt-12 font-medium">
            Fotpleie Herre
          </h2>
          <Table treatment="Mini pedikyr" price="349" />
          <p className="montserrat text-sm border-b border-gray-200">
            Mykgjørende salt, fuktighetsgivende kremmassasje
          </p>
          <Table treatment="SPA pedikyr" price="449" />
          <p className="montserrat text-sm border-b border-gray-200">
            Bløtgjørende salt, fuktighetsgivende kremmassasje, varmt håndkle,
            skrubbeeksfoliering, kremmaske, trim og neglebåndsbrudgom
          </p>
          <Table treatment="Deluxe pedikyr" price="549" />
          <p className="montserrat text-sm border-b border-gray-200">
            Mykgjørende saltbløt, nærende oljer, aromatisk oljemassasje, varm
            stein, varmt håndkle, skrubbeeksfoliering, parafinmaske, trim og
            neglebåndsbrudgom
          </p>
          <Table treatment="Hotstone / terapi pedikyr" price="649" />
          <p className="montserrat text-sm border-b border-gray-200">
            Kokosmelk fotbad, terapeutisk oljemassasje, varm stein, varmt
            håndkle, skrubbeeksfoliering, parafinmaske, trim og
            neglebåndsbrudgom
          </p>
          <Table treatment="Platinum signature pedikyr" price="749" />
          <p className="montserrat text-sm border-b border-gray-200">
            Kokosmelk fotbad, terapeutisk oljemassasje, varm stein, varmt
            håndkle, skrubbeeksfoliering, parafinmaske, trim og
            neglebåndsbrudgom
