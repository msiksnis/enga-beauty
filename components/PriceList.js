    ...
    <div className="mt-5 lg:mt-10 lg:pt-20 lg:mx-20 border-t border-gray-100">
      <div className="flex flex-col lg:flex-row lg:justify-around lg:space-x-6">
        <div className="w-full  mt-10">
          ...
          <h3 className="flex ml-6 md:ml-10 lg:ml-0 montserrat text-xl mt-4 mb-6 font-medium">
            Håndpleie Dame
          </h3>
        ...
        <div className="w-full  mt-10">
          ...
          <Image
            ...
            height={600}
          />
          <h3 className="flex ml-6 md:mx-10 lg:ml-0 montserrat text-xl mt-4 mb-6 font-medium">
            Fotpleie Dame
          </h3>
